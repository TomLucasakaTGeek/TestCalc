...
class Main {
  ...
  switch(s){
    case '+': System.out.println("Enter first number");a=o.nextInt();
              System.out.println("Enter second number");b=o.nextInt();
                ans = a+b;
                break;
      case '-':System.out.println("Enter first number");a=o.nextInt();
              System.out.println("Enter second number");b=o.nextInt();
                ans = a-b;
                break;
      case 'X':System.out.println("Enter first number");a=o.nextInt();
              System.out.println("Enter second number");b=o.nextInt();
                ans = a*b;
                break;
      case '/':System.out.println("Enter first number");a=o.nextInt();
